...
const usageMetric = computed(() => props.metrics.find(metric => metric.metric === 'usage'));
const usedMetric = computed(() => props.metrics.find(metric => metric.metric === 'used'));
const totalMetric = computed(() => props.metrics.find(metric => metric.metric === 'total'));

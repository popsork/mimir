<template lang="pug">
OrdersSidebar(v-if="selectedView" :title="$t('invoicing.orders.sidebar.headings.Edit columns')" v-on:close="closeSidebar")
    ViewsListColumns(
        v-model:selected-columns="selectedColumns"
        translation-scope="invoicing.orders.columns"
        :columns="columns"
...
const viewsStore = useInvoicingOrdersViewsStore();
